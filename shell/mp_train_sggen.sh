...
# 定义权重文件名列表
weight_files=(      "model_0015000.pth" "model_0020000.pth" "model_0025000.pth" 
                    "model_0030000.pth" "model_0035000.pth" "model_0040000.pth" "model_0045000.pth" 
                    "model_0050000.pth" "model_0055000.pth" "model_0060000.pth" )

export model_config="mp_vg" # relHetSGG_vg, relHetSGGp_vg
export output_dir="/home/yj/zgw/het/ckpt/${task}-het_mp_struct_prompt_proto_1"
mkdir ${output_dir}
